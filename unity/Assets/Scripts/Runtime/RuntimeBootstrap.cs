    ...
    public static class RuntimeBootstrap
    {
        ...
        private static void BuildUi(CityIdleGame game)
        {
            ...
            for (var i = 0; i < BalanceCatalog.Businesses.Length; i++)
            {
                ...
                var id = def.Id; start.onClick.AddListener(() => game.StartMinigame(id));
            }
            ...
            var rewardedPlay = Button(minigamePanel.transform, "광고로 광산 1판 추가", new Vector2(.12f, .36f), new Vector2(.88f, .45f));
            rewardedPlay.onClick.AddListener(() => game.StartRewardedMinigame(BusinessId.Mine));
